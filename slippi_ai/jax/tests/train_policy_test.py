#!/usr/bin/env python
"""Test policy imitation learning training loop - JAX version."""
...
from slippi_ai.jax import train_policy, networks
...
DEFAULT_CONFIG = train_policy.Config(
    ...
    learner=train_policy.learner_lib.LearnerConfig(),
    runtime=train_policy.RuntimeConfig(
        log_interval=4,
        max_runtime=10,
...
if __name__ == '__main__':
  ...
  def main(_):
    ...
    config = flag_utils.dataclass_from_dict(
        train_policy.Config, CONFIG.value)
