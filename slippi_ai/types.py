...
class StateAction(NamedTuple, Generic[S, Action]):
  ...
  # Zeros if not present; defaults to () ("missing") for callers that don't
  # use ratings, in which case the rating embedding must be disabled.
  rating: FloatArray[S] = ()  # type: ignore
