...
if __name__ == '__main__':
  ...
  from slippi_ai.rl import train_mixture_lib


  CONFIG = ff.DEFINE_dict(
      'config',
      **flag_utils.get_flags_from_default(train_mixture_lib.DEFAULT_CONFIG))
  ...
  WANDB = ff.DEFINE_dict(
      ...
      tags=ff.StringList(['mixture']),
  )

  def main(_):
    config = flag_utils.dataclass_from_dict(train_mixture_lib.Config, CONFIG.value)
